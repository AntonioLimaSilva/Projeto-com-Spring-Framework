...
public class ClasseParaErroAtributoTagProcessor extends AbstractAttributeTagProcessor {
	
	private static final String NOME_ATRIBUTO = "classeparaerro";
	private static final int PRECEDENCIA = 1000;

	public ClasseParaErroAtributoTagProcessor(String dialectPrefix) {
